...
// How about starting from the value passed in and evaluating each factor as they come in. So the first one that evaluates as Prime would be the largest prime. Should be faster if done correctly.
